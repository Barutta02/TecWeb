...
echo render_page($template, $title, $pageID, $breadcrumbs, 'Login Sushi Brombeis, Login ristorante sushi via brombeis', 'Accedi al sito ufficiale del ristorante di sushi a Napoli in via brombeis. Prenota il tuo tavolo e vieni a trovarci!', $content, 'setLoginChecks();addOnBlur();');
?>