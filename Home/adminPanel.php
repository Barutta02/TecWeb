...
echo replace_in_page($template, $title, $pageID, $breadcrumbs, 'Gestione prenotazione clienti, Sushi Brombeis, Ristorante sushi via Brombeis, piatti da fare per sushi Brombeis', 'Admin panel del sito ufficiale del ristorante di sushi a Napoli in via Brombeis.', $content, '', "Admin");
?>